...
export class ModeDoc {
    code: Code = {
        typescript: `
import { PrimeNGConfig, OverlayOptions } from '@dwii5359/primeng/api';
...
export class AppComponent implements OnInit {
    ...
    code2: Code = {
        basic: `import { PrimeNGConfig, OverlayOptions, ResponsiveOverlayDirectionType } from '@dwii5359/primeng/api';
